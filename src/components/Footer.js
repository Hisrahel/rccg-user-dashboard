      ...
      <div className="container">
        <div className="row footer-row">
          <div className="col-md-6 col-12">
            <a href="http://rccgc.netlify.app/" className="footer-logo text-white" >
              <img src={logo} alt="RCCG Logo" />
              <span className="text-white"
                >The Redeemed Christian <br />
                Church of God, <br />
                New Beginning Chapel.</span
              >
            </a>
            <div className="footer-text">
              <div>
                ...
                <a href="tel:07448583833" className="text-white"
                  ><span className="text-white"><small>07448583833</small></span></a
                >
                <br />
                <a href="mailto:info@rccgbournemouth.org" className="text-white"
                  ><span className="text-white"><small>info@rccgbournemouth.org</small></span></a
                >
          ...
          <div className="footer-links">
            ...
            <a href="http://rccgc.netlify.app/portal.html">RCCG New Beginning Chapel E-Portal</a>
          </div>
