...
function Search({ onToggleSidebar }) {
  ...
  const handleSubmit = (e) => {
    ...
    // TODO: call API or filter results
  };
          ...
          <div className="search-container">
            <form onSubmit={handleSubmit} className="search-form">
              <div className="search-input-wrapper">
                <span className="search-icon">
                  ...
                  >
                    ...
                    />
                    <path
                      d="M19 11.5C19 7.08172 15.4183 3.5 11 3.5C6.58172 3.5 3 7.08172 3 11.5C3 15.9183 6.58172 19.5 11 19.5C15.4183 19.5 19 15.9183 19 11.5Z"
                      stroke="#3B3B3B"
                      stroke-width="1.5"
                      stroke-linecap="round"
                      stroke-linejoin="round"
              ...
              <div className="filterbutton">
                ...
                >
                  <option selected>All Search Results</option>
